...
## Tu te positionnes comment — data analyst, data scientist, data engineer ?
Honnêtement, les trois se recoupent à mon niveau. Mon cœur de compétence c'est l'analyse et la modélisation (background éco/stats), mais j'ai une vraie appétence pour l'ingénierie des données — construire les pipelines, pas juste les utiliser. Je suis le plus à l'aise sur des postes qui combinent les deux. Data Analyst ou Data Scientist Junior sont les titres les plus fidèles aujourd'hui.

## Pourquoi la spécialité automobile / financement ?
