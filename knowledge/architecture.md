...
2. Une similarité cosinus en NumPy compare ce vecteur aux 79 chunks pré-calculés issus de la base de connaissance markdown.
...
Index vectoriel : NumPy cosine similarity. Pas de FAISS, pas de Pinecone, pas de Weaviate — sur 79 chunks, c'est totalement superflu.
Analytics : SQLite locale, pas de PostgreSQL — il n'y a aucune concurrence critique pour ce trafic.
Base de connaissance : 8 fichiers markdown éditables manuellement et versionnés en git, qui produisent environ 79 chunks après découpage.
